...
//officer change password process send verification code*************************
//********************************************** */
...
$user_rs = Database::search("SELECT * FROM `academic_officers` WHERE `id`='" . $id . "'");
...
if($user_num==1){
    ...
    Database::iud("UPDATE `academic_officers` SET `verification_code`='" . $code . "'");
