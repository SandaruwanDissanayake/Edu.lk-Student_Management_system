                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 mt-3">
                                                    <div class="row justify-content-end">
                                                        <button class="btn btn-success col-4 m-3" onclick="aupdateMyProfile();">Update Profile</button>
                                                ...
                                                <div class="row">
                                                    <div class="d-block" id="changePassword">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-6 col-12 mt-5">
                                                                <div class="row justify-content-end">
                                                                    <button class="btn btn-success mt-2" onclick="achangepassword('<?php echo $user['id']; ?>');">Change Password</button>
                                                    ...
                                                    <div class="d-none" id="verification">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-6 col-12 mt-5">
                                                                <div class="row justify-content-end">
                                                                    <button class="btn btn-success mt-2" onclick="achangeVerification('<?php echo $user['id']; ?>')">Submit verification code</button>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-lg-6 col-12 ">
                                                                <div class="row justify-content-end">
                                                                    ...
                                                                    <button class="btn btn-success m-2 col-6" onclick="aChangePw('<?php echo $user['id']; ?>');">Change</button>
