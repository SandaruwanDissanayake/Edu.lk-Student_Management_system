                                                ...
                                                <div class="row">
                                                    <div class="d-block">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-12 mt-5">
                                                                <div class="row justify-content-end">
                                                                    <button class="btn btn-success mt-2">Change Password</button>
                                                    ...
                                                    <div class="d-none">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-12 mt-5">
                                                                <div class="row justify-content-end">
                                                                    <button class="btn btn-success mt-2">Submit verification code</button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-12 ">
                                                                <div class="row justify-content-end">
                                                                    ...
                                                                    <button class="btn btn-success m-2 col-6">Submit verification code</button>
