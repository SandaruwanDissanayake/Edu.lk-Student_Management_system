        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="row">
                    ...
                    <div class="col-1 "></div>
                    <div class="col-10">
                        <label class=" fw-bold" style="font-size: 30px;" for="">EDU.LK Admin Log In</label>
                        <p class="mt-5 p">
                        ...
                        <div class="col-12 mt-2">
                            <div class="row">
                                <div class="col-6">
                                    <input type="text" class="col-lg-6 col-12 form-control" placeholder="Email Address" id="email">
                                </div>
                                <div class="col-6">
                                    <input type="password" class="col-lg-6 col-12 form-control" placeholder="Password" id="password">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 mt-4">
                                    <div class="row justify-content-lg-end justify-content-start">
                                        ...
                                        <button class="btn btn-success col-5 d-grid" onclick="adminSignIn();">Sign In</button>
                                    </div>
                                </div>
                            </div>
                        </div>
